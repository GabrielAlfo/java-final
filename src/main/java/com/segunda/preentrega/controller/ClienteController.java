...
import com.example.preentrega.mapper.clienteMapper
...
public class ClienteController {
    ...
    @Operation(summary = "Crear un cliente", description = "Crear un cliente asociandolo al id que ya existe. Retorna un estado de http si se crea.")
